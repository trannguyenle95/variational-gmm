...
class StreamingVariationalGMM:
    ...
    def update_with_data_shake(self, X_old, X_new):
        alpha_k_old_data, normal_wishart_params_old_data = self._get_variational_parameters(X_old)
        alpha_k_new_data, normal_wishart_params_new_data = self._get_variational_parameters(X_new)
